...
// The exact figure, always. This used to round to the nearest thousand, so a
// band of ₹18,500–₹22,500 was read aloud to a candidate as "₹19,000 to
// ₹23,000" — numbers the client never agreed to, spoken by a recruiter who had
// no way of knowing the screen had changed them. Rounding is acceptable in a
// dense table; it is not acceptable in a script somebody reads out.
function money(n) {
